    ...
    return (
        <div className="worksContainer">
            ...
            <div className="worksSecond flex flex-around text-white fade-in" ref={worksSecondRef}>
                ...
                <img src="/assets/techivation-vVRmYWSWy7A-unsplash.jpg" alt="firstWorks" className="firstWorks" />
            </div>

            <div className="worksThird flex justify-around gap-12 fade-in" ref={worksThirdRef}>
                <img src="/assets/luke-heibert-cmRK3yiOFFQ-unsplash.jpg" alt="secondWorks" className="secondWorks" />
                <div>
            ...
            <div className="worksFourth flex justify-around fade-in" ref={worksFourthRef}>
                ...
                <img src="/assets/jack-lucas-smith-eL4Jts03hpE-unsplash.jpg" alt="thirdWorks" className="thirdWorks" />
            </div>
        </div>
    );
};
